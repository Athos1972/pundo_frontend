...
description: >-
  What the KTEO is, when it's due, what it costs — and what happens if you let
  it lapse. With an international comparison.
category: mobilität
icon: "\U0001F527"
readtime: '7'
slug: mot-zypern
lang: en
published: true
hero_alt: Vehicle inspection in Cyprus — KTEO
---
...
<InfoBox type="tip">
  Vehicle fees, deadlines and regulations in Cyprus change regularly. [naidivse.cy](https://naidivse.cy) keeps the current information together — worth bookmarking.
</InfoBox>
