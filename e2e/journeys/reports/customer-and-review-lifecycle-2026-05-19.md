...
| 6 | Test-Shop-Seite aufrufen | Kein 404 | http://127.0.0.1:3500/shops/e2e-test-shop | PASS |
...
| 10 | Admin Moderation-Liste aufrufen | /admin/reviews oder Login-Redirect | http://127.0.0.1:3500/admin/login | PASS |
...
|---|---|---|
| e2e-carl-acf54b03-customer | versucht | best-effort |