...
| 2 | Suchbegriff eingeben → Navigation | URL enthält /search oder q= | http://localhost:3500/search?q=E2E%20Test%20Shop | PASS |
| 3 | Suchergebnisse — mindestens 1 Karte | ≥1 Karte sichtbar | keine Karten | SKIP |
| 4 | Produkt-Detailseite aufrufen | URL /products/<slug> | http://localhost:3500/products/no-brand-source | PASS |
