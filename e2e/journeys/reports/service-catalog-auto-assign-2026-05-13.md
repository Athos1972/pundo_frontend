...
**Datum:** 2026-05-13T21:56:35.551Z
**Frontend:** http://localhost:3500
**Backend:** http://localhost:8500
**Test-Owner:** e2e-sca-6844a9be@pundo-e2e.io
...
| S6a | Shop-Seite erreichbar | HTTP 200, Shop-Seite sichtbar | http://localhost:3500/shops/e2e-sca-shop-6844a9be | **PASS** |
...
- AC-5b: Keine auto_seeded Listings für Owner e2e-sca-6844a9be@pundo-e2e.io. Mögliche Ursachen: 1) Onboarding-Endpoint existiert nicht oder hat falsche Parameter, 2) Auto-Assign-Worker wurde bei Approve nicht getriggert, 3) Domäne elektriker hat keine Mappings für diesen Shop-Type
- S6b: Keine Listings in Customer-Sicht. Shop-URL=http://localhost:3500/shops/e2e-sca-shop-6844a9be. Möglicherweise: 1) shop nicht öffentlich, 2) Geo-Koordinaten fehlen, 3) available=false