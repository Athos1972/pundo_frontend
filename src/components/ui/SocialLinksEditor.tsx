            ...
            <div className="flex-1">
              <input
                ...
                className={`w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2
                  ...
                  ${urlErrors[key] ? 'border-red-400' : 'border-gray-300'}`}
              />
              {urlErrors[key] && (
                <p className="mt-0.5 text-xs text-red-500">{urlErrors[key]}</p>
              )}
            </div>
          </div>
        ))}
            ...
            <div className="flex-1">
              <input
                ...
                className={`w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2
                  ...
                  ${urlErrors.other ? 'border-red-400' : 'border-gray-300'}`}
              />
              {urlErrors.other && (
                <p className="mt-0.5 text-xs text-red-500">{urlErrors.other}</p>
              )}
            </div>
          </div>
        </div>
