...
const guidesTranslations = {
  en: {
    ...
    category_gemeinschaft: 'Community & Charity',
  ...
  de: {
    ...
    category_gemeinschaft: 'Gemeinschaft & Charity',
    page_title_blog: 'Blog',
    blog_index_title: 'Blog',
  ...
  ru: {
    ...
    category_gemeinschaft: 'Сообщество и благотворительность',
  ...
  el: {
    ...
    category_gemeinschaft: 'Κοινότητα & Φιλανθρωπία',
    page_title_blog: 'Blog',
    blog_index_title: 'Blog',
  ...
  ar: {
    ...
    category_gemeinschaft: 'المجتمع والخير',
  ...
  he: {
    ...
    category_gemeinschaft: 'קהילה וצדקה',
