...
const homeTranslations = {
  en: {
    ...
    category_grid_all: 'All categories →',
  ...
  de: {
    ...
    category_grid_all: 'Alle Kategorien →',
  ...
  el: {
    ...
    category_grid_all: 'Όλες οι κατηγορίες →',
  ...
  ru: {
    ...
    category_grid_all: 'Все категории →',
  ...
  he: {
    ...
    category_grid_all: '← כל הקטגוריות',
