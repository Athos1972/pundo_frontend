export const translations = {
  en: {
    ...
    fab_homesick_onboarding_text: "Something from home you can't find here? Describe it — we'll find it in Cyprus.",
    fab_spotted_onboarding_text: 'In a shop? Snap a product — the community will love it!',
    fab_dismiss_label: 'Dismiss',
    homesick_teaser_headline: 'What do you miss from home?',
    homesick_teaser_text: "The tea your grandma made, the bread from your childhood, that one snack you can't find anywhere — tell us what you miss. We'll find what comes closest, right here in Cyprus.",
    homesick_teaser_cta: 'Tell us what you miss',
  ...
  de: {
    ...
    fab_spotted_label: 'Spotted',
    fab_homesick_onboarding_text: 'Etwas von zuhause, das du vermisst? Beschreib\'s uns – wir finden\'s hier in Zypern.',
    ...
    homesick_teaser_headline: 'Was vermisst du von zuhause?',
    homesick_teaser_text: 'Den Tee deiner Oma, das Brot von früher, die Süßigkeit aus der Kindheit – sag uns, was dir fehlt. Wir finden, was hier in Zypern am nächsten dran ist.',
    homesick_teaser_cta: 'Sag uns, was dir fehlt',
  ...
  ru: {
    ...
    fab_spotted_label: 'Spotted',
    fab_homesick_onboarding_text: 'Скучаешь по чему-то из дома? Опиши — мы найдём похожее на Кипре.',
    fab_spotted_onboarding_text: 'В магазине? Сфотографируй товар — сообщество оценит!',
    fab_dismiss_label: 'Закрыть',
    homesick_teaser_headline: 'По чему ты скучаешь из дома?',
    // TODO: native speaker review
    homesick_teaser_text: 'Бабушкин чай, хлеб из детства, та самая конфета, которую нигде не найти — расскажи, чего тебе не хватает. Мы найдём ближайшее на Кипре.',
    homesick_teaser_cta: 'Расскажи, чего тебе не хватает',
  ...
  el: {
    ...
    fab_spotted_label: 'Spotted',
    fab_homesick_onboarding_text: 'Κάτι από το σπίτι που δεν βρίσκεις εδώ; Περίγραψέ το — θα το βρούμε στην Κύπρο.',
    fab_spotted_onboarding_text: 'Σε κατάστημα; Φωτογράφισε ένα προϊόν — η κοινότητα θα χαρεί!',
    fab_dismiss_label: 'Κλείσιμο',
    homesick_teaser_headline: 'Τι σου λείπει από το σπίτι;',
    // TODO: native speaker review
    homesick_teaser_text: 'Το τσάι της γιαγιάς, το ψωμί από τα παιδικά σου χρόνια, εκείνο το γλυκό που δεν βρίσκεις πουθενά — πες μας τι σου λείπει. Θα βρούμε ό,τι πιο κοντινό υπάρχει εδώ στην Κύπρο.',
    homesick_teaser_cta: 'Πες μας τι σου λείπει',
  ...
  ar: {
    ...
    fab_spotted_label: 'Spotted',
    fab_homesick_onboarding_text: 'شيء من بلدك تشتاق إليه ولا تجده هنا؟ صفه لنا — سنجده في قبرص.',
    fab_spotted_onboarding_text: 'في متجر؟ صوّر منتجًا — المجتمع سيقدّر ذلك!',
    fab_dismiss_label: 'إغلاق',
    homesick_teaser_headline: 'ما الذي تشتاق إليه من بلدك؟',
    // TODO: native speaker review
    homesick_teaser_text: 'الخبز الذي اعتدت عليه، البهارات من مطبخ أمك، الحلوى التي لا تجدها في أي مكان — أخبرنا بما تفتقده. سنجد الأقرب إليه هنا في قبرص.',
    homesick_teaser_cta: 'أخبرنا بما تفتقده',
    nav_homesick: 'حنين',
    // F4700 — Recently Viewed & Activity Feed
  ...
  he: {
    ...
    fab_spotted_label: 'Spotted',
    fab_homesick_onboarding_text: 'משהו מהבית שאתה מתגעגע אליו ולא מוצא? תאר אותו — נמצא אותו בקפריסין.',
    fab_spotted_onboarding_text: 'בחנות? צלם מוצר — הקהילה תשמח!',
    fab_dismiss_label: 'סגור',
    homesick_teaser_headline: 'למה אתה מתגעגע מהבית?',
    // TODO: native speaker review
    homesick_teaser_text: 'התה של סבתא, הלחם מהילדות, הממתק הזה שאי אפשר למצוא בשום מקום — ספר לנו למה אתה מתגעגע. נמצא את הקרוב ביותר כאן בקפריסין.',
    homesick_teaser_cta: 'ספר לנו למה אתה מתגעגע',
