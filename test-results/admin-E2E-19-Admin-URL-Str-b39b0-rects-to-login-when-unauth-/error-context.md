...
- Name: admin.spec.ts >> E2E-19: Admin URL Structure >> admin/offers URL loads (redirects to login when unauth)
- Location: e2e/admin.spec.ts:368:7
...
Call log:
  - navigating to "http://127.0.0.1:3500/admin/offers", waiting until "load"
