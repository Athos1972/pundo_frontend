...
- Name: admin.spec.ts >> E2E-19: Admin URL Structure >> admin/categories?view=tree URL is syntactically valid
- Location: e2e/admin.spec.ts:384:7
...
Call log:
  - navigating to "http://127.0.0.1:3500/admin/categories?view=tree", waiting until "load"
