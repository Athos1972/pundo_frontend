...
- Name: coming-soon.spec.ts >> Coming-Soon — RTL (Arabisch) >> Arabischer Tagline-Text sichtbar
- Location: e2e/coming-soon.spec.ts:83:7
...
Locator: getByText('اعثر على كل شيء.')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('اعثر على كل شيء.')
