...
- Name: shop-card-enrichment.spec.ts >> E2E-S7: Neue Filter-Chips >> Sprach-Chip toggle: kein Crash beim Klick (EL)
- Location: e2e/shop-card-enrichment.spec.ts:388:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'EL' }) resolved to 2 elements:
