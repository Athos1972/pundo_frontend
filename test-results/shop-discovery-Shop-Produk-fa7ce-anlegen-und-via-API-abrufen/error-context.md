...
- Name: shop-discovery.spec.ts >> Shop-Produkt via Admin anlegen >> Produkt anlegen und via API abrufen
- Location: e2e/shop-discovery.spec.ts:240:7
...
Call log:
  - navigating to "http://127.0.0.1:3500/shop-admin/products/new", waiting until "load"
